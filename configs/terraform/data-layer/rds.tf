...
resource "aws_db_instance" "mysql" {
  ...
  lifecycle {
    # Keep apply idempotent when importing pre-existing DB instances.
    # Password is write-only in AWS and should be rotated explicitly, not as a
    # side effect of Terraform state recreation.
